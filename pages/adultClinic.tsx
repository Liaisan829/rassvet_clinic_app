...
import styles from "../styles/adultClinic.module.scss";
    ...
    return (
        <BaseLayout title="Взрослая клиника">
            <div className={styles.clinic}>
                ...
                <p className={styles.clinic__p}>Взрослое отделение клиники Рассвет — это безболезненное медицинское сопровождение на всех этапах
